...
/**
 * Created by desarrolladorandroid on 18/10/16.
 */

public class SrPagoLocationManager extends Service implements LocationListener {
    ...
    public SrPagoLocationManager(Context context) {
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            locationManager.removeUpdates(SrPagoLocationManager.this);
        }
    }
